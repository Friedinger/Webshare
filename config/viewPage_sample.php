...
<head>
	<title>Webshare | <?= Webshare\Output::$value ?></title>
	...
	<script>
		function copyLink() {
			navigator.clipboard.writeText("https://<?= Webshare\Output::url() ?>");
...
<body>
	<header>
		<div class="fileName"><?= Webshare\Output::$value ?></div>
	...
	<main><?= Webshare\Output::$sharePreview ?></main>
</body>
